...
export const nextPlayer = (playerNumber: number, clockwiseDirection: boolean) => {
    const theoreticalNextPlayer: number = clockwiseDirection ? playerNumber + 1 : playerNumber - 1;
